...
## What This Does
Fetches an article from a URL, saves a clean markdown copy to `raw/notes/YYYY-MM/`, then compiles the content into 5–15 wiki pages.
...
- Save to `raw/notes/YYYY-MM/YYYY-MM-DD-slug.md` with this frontmatter:
...
1. Check if a page already exists in `wiki/concepts/` or `wiki/tools/`
...
4. Wikilink aggressively — every concept and tool gets `[[linked]]`
...
```
Saved raw article → raw/notes/2026-04/2026-04-18-article-title.md
Created: wiki/concepts/concept-a.md
Updated: wiki/concepts/existing-concept.md (+3 paragraphs, +1 source)
Updated: wiki/tools/relevant-tool.md
Index updated: 1 new page, 2 updated
```
