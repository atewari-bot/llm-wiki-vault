...
def main():
    ...
    parser.add_argument("--mark-processed", action="store_true",
                        help="Tag inbox files as processed after ingestion")
    ...
    if args.vault:
        ...
        subfolders = ["inbox"] if args.inbox_only else None
        label = "raw/inbox/" if args.inbox_only else "raw/"
        print(f"📂 Reading {label}  ({vault_path})")
        notes = parse_raw(str(vault_path), subfolders=subfolders)
